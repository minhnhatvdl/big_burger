...
// in big_burger/test/mocking/mock_api_test.dart.
...
import 'package:big_burger/data/apis/clients/http.client.dart' as _i6;
...
class MockHttpClient extends _i1.Mock implements _i6.HttpClient {
  ...
  @override
  _i3.Future<_i2.Response> get(Uri? url) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [url],
        ),
